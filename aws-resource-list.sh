...
#################################################
# This will list all the resorces in AWS account
# Author: Isaiah
# Version v0.01

# The following are supportde AWS services by the scripts
# 1. EC2
# 2. S3
# 3. RDS
# 4. DyanmoDB
...
# Check if the reqiured number of arguments are passed
if [ $# -ne 2 ]; then
